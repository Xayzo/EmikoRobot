...
LOGGER = logging.getLogger('[DionRobot]')
LOGGER.info("DionRobot is starting. | An Dion Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/SeorangDion (t.me/Royzu)")
